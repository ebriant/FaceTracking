...
input = io.imread('../test/assets/a_001.jpg')
preds = fa.get_landmarks(input)[-1]
plot(input, preds)
input = io.imread('../test/assets/b_001.jpg')
preds = fa.get_landmarks(input)[-1]
plot(input, preds)
input = io.imread('../test/assets/c_001.jpg')
preds = fa.get_landmarks(input)[-1]
plot(input, preds)
input = io.imread('../test/assets/d_001.jpg')
preds = fa.get_landmarks(input)[-1]
plot(input, preds)
input = io.imread('../test/assets/e_001.jpg')
preds = fa.get_landmarks(input)[-1]
plot(input, preds)
input = io.imread('../test/assets/f_001.jpg')
preds = fa.get_landmarks(input)[-1]
plot(input, preds)
